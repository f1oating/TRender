...
public:
	...
	void AddPixelShader(std::string name, LPCWSTR path, ID3D11Device* device);
	void AddGeometryShader(std::string name, LPCWSTR path, ID3D11Device* device);
	...
	void BindGeometryShader(std::string name, ID3D11DeviceContext* deviceContext);

	void UnbindVertexShader(std::string name, ID3D11DeviceContext* deviceContext);
	void UnbindPixelShader(std::string name, ID3D11DeviceContext* deviceContext);
	void UnbindGeometryShader(std::string name, ID3D11DeviceContext* deviceContext);
...
private:
	...
	std::unordered_map<std::string, ID3D11GeometryShader*> m_GeometryShadersMap;
